...
# --- DISPERSIÓN WOD 1 ---
dispersion1 <- ggplot(df, aes(x = `WOD 1_Res_Adj`, y = `WOD 1_Pos`)) +
...
# --- DISPERSIÓN WOD 2 ---
dispersion2 <-ggplot(df, aes(x = `WOD 2_Res_Adj`, y = `WOD 2_Pos`)) +
  geom_point(color = "steelblue", alpha = 0.5, size = 2) +
  geom_smooth(method = "lm", color = "red", linetype = "dashed", se = FALSE) + 
  geom_smooth(method = "loess", color = "darkblue", se = TRUE, alpha = 0.2) +
  scale_y_reverse() + theme_minimal() +
...
# --- DISPERSIÓN WOD 3 ---
dispersion3 <-ggplot(df, aes(x = `WOD 3_Res_Adj`, y = `WOD 3_Pos`)) +
  geom_point(color = "steelblue", alpha = 0.5, size = 2) +
  geom_smooth(method = "lm", color = "red", linetype = "dashed", se = FALSE) + 
  geom_smooth(method = "loess", color = "darkblue", se = TRUE, alpha = 0.2) +
  scale_y_reverse() + theme_minimal() +
...
# --- DISPERSIÓN WOD 4 ---
dispersion4 <- ggplot(df, aes(x = `WOD 4_Res_Adj`, y = `WOD 4_Pos`)) +
  geom_point(color = "steelblue", alpha = 0.5, size = 2) +
  geom_smooth(method = "lm", color = "red", linetype = "dashed", se = FALSE) + 
  geom_smooth(method = "loess", color = "darkblue", se = TRUE, alpha = 0.2) +
  scale_y_reverse() + theme_minimal() +
...
# --- DISPERSIÓN WOD 5 ---
dispersion5 <-ggplot(df, aes(x = `WOD 5_Res_Adj`, y = `WOD 5_Pos`)) +
  geom_point(color = "steelblue", alpha = 0.5, size = 2) +
  geom_smooth(method = "lm", color = "red", linetype = "dashed", se = FALSE) + 
  geom_smooth(method = "loess", color = "darkblue", se = TRUE, alpha = 0.2) +
  scale_y_reverse() + theme_minimal() +
...
save(df_audit, df_consistencia, df, dificultad_wods, file = "data/df_eda_processed.RData")
